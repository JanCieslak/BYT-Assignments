...
public class QuadrilateralTest {
	...
	public void setUp() throws Exception {
		...
		rectangle1 = new Quadrilateral(new Point(4, 2), new Point(10, 2), new Point(10, 4), new Point(4, 4));
		rectangle2 = new Quadrilateral(new Point(-2, -1), new Point(-2, 1), new Point(10, 1), new Point(10, -1));
		quad = new Quadrilateral(new Point(-2, -2), new Point(1, 1), new Point(-21, 1), new Point(-21, -1));
	}
